        ...
        <Fragment>
                        ...
                        <div className="flex space-x-12 text-xl relative">
                            ...
                            <div className="relative group">
                                ...
                                <div className="absolute z-50 -left-48 hidden group-hover:flex mt-0 w-max space-x-4 bg-white dark:bg-[#1D1E1F] p-6 shadow-lg dark:bg-surface-dark border dark:border-[#3B3C40] rounded-3xl">
                                    <Link
                                        href="/recentUserOps"
                                        className="block rounded-lg border dark:border-none bg-[#29903B] bg-opacity-10 dark:bg-[#222E28] dark:hover:bg-[#2F4038] hover:bg-opacity-25  p-6 text-surface shadow-secondary-1 dark:bg-surface-dark dark:text-white w-48 h-36"
                                    >
                                        <img src="/images/UserOp.svg" alt="" />
                                        <button
                                            type="button"
                                            className="inline-block rounded font-gsans bg-primary mt-0 mr-10 text-left pb-2 pt-2.5 text-xl font-medium leading-normal text-[#29903B] dark:text-[#56B48C] hover:bg-opacity-50 dark:hover:bg-opacity-50 shadow-primary-3 transition duration-150 ease-in-out hover:bg-primary-accent-300 hover:shadow-primary-2 focus:bg-primary-accent-300 focus:shadow-primary-2 focus:outline-none focus:ring-0 active:bg-primary-600 active:shadow-primary-2 dark:shadow-black/30 dark:hover:shadow-dark-strong dark:focus:shadow-dark-strong dark:active:shadow-dark-strong"
                                        >
                                            User Ops
                                        </button>
                                    </Link>
                                    ...
                                    >
                                        ...
                                        <button
                                            type="button"
                                            className="inline-block rounded font-gsans bg-primary mt-0 mr-10 text-left  pb-2 pt-2.5 text-xs font-medium leading-normal text-[#2882A1] dark:text-[#69A1D6] shadow-primary-3 transition duration-150 ease-in-out hover:bg-primary-accent-300 hover:shadow-primary-2 focus:bg-primary-accent-300 focus:shadow-primary-2 focus:outline-none focus:ring-0 active:bg-primary-600 active:shadow-primary-2 dark:shadow-black/30 dark:hover:shadow-dark-strong dark:focus:shadow-dark-strong dark:active:shadow-dark-strong"
                                        >
                                            Bundles
                                        </button>
                                    </Link>
                                    <Link
                                        href="/paymasters"
                                        className="block rounded-lg border  dark:border-none bg-[#B43E70] dark:bg-[#352532] hover:bg-opacity-25 bg-opacity-10 dark:hover:bg-[#422E3F] p-6 text-surface shadow-secondary-1 dark:bg-surface-dark dark:text-white w-48 h-36"
                                    >
                                    ...
                                    <Link
                                        href="/bundlers"
                                        className="block rounded-lg border  dark:border-none bg-[#8F6D28] dark:bg-[#353125] hover:bg-opacity-25 bg-opacity-10 dark:hover:bg-[#423E2E] p-6 text-surface shadow-secondary-1 dark:bg-surface-dark dark:text-white w-48 h-36"
                                    >
                                        <img src="/images/Bundlers.svg" alt="" />
                                        <button
                                            type="button"
                                            className="inline-block rounded font-gsans bg-primary mt-0 mr-10 text-left  pb-2 pt-2.5 text-xs font-medium leading-normal text-[#8F6D28] dark:text-[#BBB523] shadow-primary-3 transition duration-150 ease-in-out hover:bg-primary-accent-300 hover:shadow-primary-2 focus:bg-primary-accent-300 focus:shadow-primary-2 focus:outline-none focus:ring-0 active:bg-primary-600 active:shadow-primary-2 dark:shadow-black/30 dark:hover:shadow-dark-strong dark:focus:shadow-dark-strong dark:active:shadow-dark-strong"
                                        >
                                            Bundlers
                                        </button>
                                    </Link>
                                    <Link
                                        href="/factories"
                                        className="block rounded-lg border dark:border-none bg-[#6E3AC2] dark:bg-[#292234] hover:bg-opacity-25 bg-opacity-10 dark:hover:bg-[#322A40] p-6 text-surface shadow-secondary-1 dark:bg-surface-dark dark:text-white w-48 h-36"
                                    >
                                        <img src="/images/Factories.svg" alt="" />
                                        <button
                                            type="button"
                                            className="inline-block rounded font-gsans bg-primary mt-0 mr-10 text-left pb-2 pt-2.5 text-xs font-medium leading-normal text-[#4F288F] dark:text-[#AF8EE4] shadow-primary-3 transition duration-150 ease-in-out hover:bg-primary-accent-300 hover:shadow-primary-2 focus:bg-primary-accent-300 focus:shadow-primary-2 focus:outline-none focus:ring-0 active:bg-primary-600 active:shadow-primary-2 dark:shadow-black/30 dark:hover:shadow-dark-strong dark:focus:shadow-dark-strong dark:active:shadow-dark-strong"
                                        >
                                            Factories
                                        </button>
                                    </Link>
                            ...
                            <div className="relative group">
                                ...
                                <div className="absolute z-50 -left-96 hidden group-hover:flex mt-0 w-max space-x-4 bg-white dark:bg-[#1D1E1F] p-6 shadow-lg dark:bg-surface-dark border dark:border-[#3B3C40] rounded-3xl">
                                    <Link
                                        ...
                                        target="_blank"
                                        className="block rounded-lg border  dark:border-none bg-[#29903B] dark:hover:bg-[#243D32] bg-opacity-25 hover:bg-opacity-35 p-6 text-surface shadow-secondary-1 dark:bg-surface-dark dark:text-white w-72"
                                    >
                                        <FaGithub className="w-10 h-10 mt-8 fill-[#29903B] dark:fill-[#56D48C]" />
                                        <button
                                            type="button"
                                            className="inline-block rounded font-gsans bg-primary  pb-2 pt-2.5 text-xs font-medium leading-normal text-[#29903B] dark:text-[#56D48C] shadow-primary-3 transition duration-150 ease-in-out hover:bg-primary-accent-300 hover:shadow-primary-2 focus:bg-primary-accent-300 focus:shadow-primary-2 focus:outline-none focus:ring-0 active:bg-primary-600 active:shadow-primary-2 dark:shadow-black/30 dark:hover:shadow-dark-strong dark:focus:shadow-dark-strong dark:active:shadow-dark-strong"
                                        >
                                            Github
                                        </button>
                                    </Link>
                                    <Link
                                        ...
                                        className="block rounded-lg border  dark:border-none bg-[#B43E70] dark:bg-[#352532] dark:hover:bg-[#42293E]  bg-opacity-20 hover:bg-opacity-35 p-6 text-surface shadow-secondary-1 dark:bg-surface-dark dark:text-white w-72"
                                    >
                                        <svg
                                            width="47"
                                            height="46"
                                        ...
                                        >
                                            <path
                                                ...
                                                fill="#B43E70"
                                                className="dark:fill-[#C472B6]"
                                            />
                                        </svg>

                                        <button
                                            type="button"
                                            className="inline-block rounded font-gsans bg-primary  pb-2 pt-2.5 text-xs font-medium leading-normal text-[#B43E70] dark:text-[#C472B6] shadow-primary-3 transition duration-150 ease-in-out hover:bg-primary-accent-300 hover:shadow-primary-2 focus:bg-primary-accent-300 focus:shadow-primary-2 focus:outline-none focus:ring-0 active:bg-primary-600 active:shadow-primary-2 dark:shadow-black/30 dark:hover:shadow-dark-strong dark:focus:shadow-dark-strong dark:active:shadow-dark-strong"
                                        >
                                            API Reference
                                        </button>
                                    </Link>
                                    <Link
                                        ...
                                        className="block rounded-lg border dark:border-none bg-[#8F6D28] dark:bg-[#312623] hover:dark:bg-[#3E2C26] bg-opacity-25 hover:bg-opacity-35 p-6 text-surface shadow-secondary-1 dark:bg-surface-dark dark:text-white w-72"
                                    >
                                        <svg
                                            width="35"
                                            height="45"
                                        ...
                                        >
                                            <path
                                                ...
                                                fill="#8F6D28"
                                                className="dark:fill-[#B96447]"
                                            />
                                        </svg>

                                        <button
                                            type="button"
                                            className="inline-block rounded font-gsans bg-primary dark:text-[#B96447]  pb-2 pt-2.5 text-xs font-medium leading-normal text-[#8F6D28] shadow-primary-3 transition duration-150 ease-in-out hover:bg-primary-accent-300 hover:shadow-primary-2 focus:bg-primary-accent-300 focus:shadow-primary-2 focus:outline-none focus:ring-0 active:bg-primary-600 active:shadow-primary-2 dark:shadow-black/30 dark:hover:shadow-dark-strong dark:focus:shadow-dark-strong dark:active:shadow-dark-strong"
                                        >
                                            Faced any Issue?
                                        </button>
                                    </Link>
                    ...
                    {currentPath === '/' && (
                        <div className="items-center align-middle justify-center mt-1 md:flex hidden">
                            <a href="https://dashboard.jiffyscan.xyz/" target="_blank" rel="noopener noreferrer">
                                <button
                                    type="button"
                                    className="flex justify-center items-center text-[#6C47FF] dark:text-[#8F73FF] bg-[#E9E4FF] hover:bg-[#E2DAFF] dark:bg-opacity-15 dark:bg-[#6C47FF] dark:hover:bg-[#363155] focus:outline-none focus:ring-4 focus:ring-purple-300 font-medium rounded-full text-base px-6 py-3 text-center mb-2 gap-2"
                                >
                                    <img src="/images/dashboardL.svg" alt="" className="dark:hidden flex" />
                                    <img src="/images/dashboardD.svg" alt="" className="dark:flex hidden" />
                                    Dashboard
                                </button>
                            </a>
                        </div>
            ...
            <Drawer open={isOpen} onClose={toggleDrawer} direction="left">
                <div className="flex flex-col justify-between min-h-screen gap-10 p-4 pb-6">
                    <Logo />
                    <Pages />
                     <div className="items-center align-middle justify-center mt-1 ">
                            <a href="https://dashboard.jiffyscan.xyz/" target="_blank" rel="noopener noreferrer">
                                <button
                                    type="button"
                                    className="flex justify-center items-center text-[#6C47FF] dark:text-[#8F73FF] bg-[#E9E4FF] hover:bg-[#E2DAFF] dark:bg-opacity-15 dark:bg-[#6C47FF] dark:hover:bg-[#363155] focus:outline-none focus:ring-4 focus:ring-purple-300 font-medium rounded-full text-base px-6 py-3 text-center mb-2 gap-2"
