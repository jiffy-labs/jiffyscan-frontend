...
function IconButton({ icon }: { icon: string }) {
    ...
    return (
        <div className="relative">
            ...
            {isDropdownOpen && (
                <div className="absolute top-12  right-[10px] text-black px-4 py-6 rounded bg-white" style={{ width: '200px' }}>
                    ...
                    <hr className="mt-2" />
                    <div
                        className="border border-black rounded mt-4 text-center p-1 gap-2 flex align-item-center justify-center"
